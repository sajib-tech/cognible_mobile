...
class TransitionQuestions extends Component {
  constructor(props) {
    super(props);
    this.state = {
      currentIndex:0,
  ...
  render() {
    ...
    const { questions, currentQuestion, currentIndex,questionLength, completed, scoreboard, loadingQuestion, levels, totalScore, previous, next } = this.state;
