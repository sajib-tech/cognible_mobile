...
class CogniableAssessment extends Component {
  ...
  fetchQuestions() {
    ...
    ParentRequest.fetchCogniableAssessmentQuestions()
      .then((dataResult) => {
  ...
  getQuestionData() {
    let data = [
      {
        index: 'A',
        title: 'Verbally fluent',
        descr: 'Describe what verbally fluent means in a line',
        selected: false,
      },
      {
        index: 'B',
  ...
  recordPreAssess(question, answer) {
    ...
    ParentRequest.saveCogniableAssessmentAnswer(variables)
      .then((dataResult) => {
      ...
      <>
        {selectedQuestion && (
          <ScrollView style={styles.scrollView}>
            ...
            <Image
              source={require('../../../android/img/question.png')}
              style={{
                width: '100%',
                height: 200,
                resizeMode: 'cover',
          ...
          <View style={Styles.rowBetween}>
            <View
              ...
              <Text style={{color: Color.blueFill}}>
                {questionNum} of {questions.length} Answered
              </Text>
              <View
    ...
    return (
      <>
        ...
        <ScrollView contentInsetAdjustmentBehavior="automatic">
          {questions.length == 0 && <NoData>No Questions Available</NoData>}
        ...
        <Container>
          ...
          {OrientationHelper.getDeviceOrientation() == 'landscape' && (
            <Row style={{flex: 1}}>
              ...
              <Column>{this.renderSidebar()}</Column>
            </Row>
          )}
        </Container>
      </SafeAreaView>
