...
class BehaviouralStartPage extends Component {
    ...
    validateForm() {
        ...
        if (this.state.selectedStatus == null) {
            this.setState({ statusErrorMessage: 'Please choose Behaviourl' });
            anyError = true;
        }
    ...
    addNewGoal() {
        ...
        TherapistRequest.createLongTerm(queryString, refetchQueries).then(longTerm => {
            ...
            if (longTerm.data.createLongTerm.details.id) {
                ...
                this.props.navigation.navigate('BehaviouralNewPage', {})
                Alert.alert(
        ...
        return (
            <SafeAreaView style={styles.container}>
                ...
                <Container enablePadding={this.props.disableNavigation != true}>
                    ...
                    >
                        ...
                        /> */}
                         <View style ={{marginTop:20}} >
                             <Text style ={{paddingLeft:5,fontSize:22}}>What behavior are challenging to you ?</Text>
                                <PickerModal style ={{marginTop:10}}
                    ...
                    <Button labelButton='Start Assessments'
...
export default connect(mapStateToProps, mapDispatchToProps)(BehaviouralStartPage);
