...
class CogniableSuggestedTargets extends Component {
    constructor(props) {
        super(props);
        this.state = {
            isLoading: false,
    ...
    getTargets() {
        ...
        console.log(pk,'pkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk');
        ...
        TherapistRequest.cogniableSuggestedTargets(variables).then(result => {
            ...
            console.log("klakslscbdhssldhd",newTargets)
            this.setState({ targets: newTargets,isLoading:false })
    ...
    getTargetView(target, index) {
        ...
        return (
            <TouchableOpacity style={[styles.card, { backgroundColor }]} key={index} onPress={() => {
                ...
                console.log("sjsjsjsjsjsnccndm",target.node.id)
                ...
                if (OrientationHelper.getDeviceOrientation() == 'portrait') {
                    this.props.navigation.navigate('TargetAllocateNewAssess', {
                        ...
                        student: student,
                        program: program,
                        img:require('../../../../android/img/cog.jpg')
                    });
                } else {
                    this.props.navigation.navigate('TargetAllocateNewAssess', {
                        target: target,
                ...
                {/*<Image style={styles.targetViewImage} source={require('../../../../android/img/cog.jpg')} />*/}
            ...
            <>
                ...
                <ScrollView keyboardShouldPersistTaps='handled'
                    ...
                    {this.state.isLoading && (
                        ...
                        // }} />
                        <Text style={{alignSelf:'center',marginTop:'45%'}}>{getStr("TargetAllocate.Loading")} ...</Text>
                    )}
        ...
        return (
            <SafeAreaView style={styles.container}>
                <NavigationHeader
                    ...
                    title={getStr("TargetAllocate.CogniAbleSuggestedTargets")} />
...
export default connect(mapStateToProps, mapDispatchToProps)(CogniableSuggestedTargets);
