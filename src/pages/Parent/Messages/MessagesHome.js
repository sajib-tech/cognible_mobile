...
class MessagesHome extends Component {
    ...
    getData() {
        ...
        ParentRequest.getMessageList().then((result) => {
    ...
    getStaffData() {
        ...
        ParentRequest.getChatUserList().then((result) => {
            ...
            <>
                <View style={{
                    ...
                    <SearchInput
                        ...
                        placeholder={getStr('ExtraAdd.SearchMessages')}
                    // clearIcon
                    />
                </View>
                    ...
                    {OrientationHelper.getDeviceOrientation() == 'portrait' && (
                        <>
                            ...
                            <Row style={{ paddingTop: 12, paddingBottom: 10 }}>
                                <Column>
                                    <Text style={styles.title}>{getStr('ExtraAdd.Messages')}</Text>
                                </Column>
                                <Column>
