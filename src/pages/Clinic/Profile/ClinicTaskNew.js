...
class ClinicTaskNew extends Component {
  constructor(props) {
    super(props);
  ...
  getData() {
    ...
    ClinicRequest.getTaskInit()
      .then((taskData) => {
        console.log('gdgdgdgddghsjska', JSON.stringify(taskData));
        ...
        if (this.params) {
          ...
          //     selFrequency.push(item.node.id)
          //   })
          // }
          ...
          if (this.params.node.remainders.edges.length != 0) {
            ...
            this.params.node.remainders.edges.map((item) => {
              ...
              console.error("rfreq item", item)

              item.node.frequency.edges.map((i) => {
                console.error("frequency", i)
                freque.push(i?.node?.name)
              })
  ...
  saveTask() {
    ...
    // return;
    console.error('yyffdggdgdgd======================query params', JSON.stringify(queryString));
                ...
                <View>
                  ...
                  <>
                    ...
                    {this.state.reminders.map((reminder, key) => {
                      console.log('Remiderlog', reminder);
...
export default connect(mapStateToProps, mapDispatchToProps)(ClinicTaskNew);
