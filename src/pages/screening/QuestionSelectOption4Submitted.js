...
class QuestionSelectOption4Submitted extends Component {
    constructor(props) {
        super(props);
    }
    getQuestionData() {
        let data = [
            {index: "A", title: "Verbally fluent",descr: 'Describe what verbally fluent means in a line', selected: true},
...
export default QuestionSelectOption4Submitted;