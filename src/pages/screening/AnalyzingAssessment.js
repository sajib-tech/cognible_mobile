...
class AnalyzingAssessment extends Component {
    constructor(props) {
        super(props);
    }
                ...
                <ScrollView contentInsetAdjustmentBehavior="automatic" style={styles.scrollView}>
                    <View style={styles.wrapper}>
                        ...
                        <View style={styles.header}>
                            ...
                            <Text style={styles.headerTitle}>Analyzing Assessment</Text>
                        </View>
                    </View>
                    ...
                    <View style={{padding: 20}}>
                        ...
                        <View style={styles.assessmentView}>
                            <Text style={styles.step}>STEP 2 . 8 - 10 MIN</Text>
                            <Text style={styles.title}>Screening Instructions</Text>
                            <Text style={styles.description}>
                                Engage with Kunal as prescribed by the script while recording the whole activity
                            </Text>
                        </View>
                        <View pointerEvents="none" style={styles.assessmentView}>
...
export default AnalyzingAssessment;