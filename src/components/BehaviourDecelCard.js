                ...
                <TouchableOpacity
                  onPress={() => {
                    if (item === 'FR') {
                      ...
                      navigation.navigate('BehaviorDRRecords', {
                        studentId,
                        tempId,
                      });
                    } else if (item === 'LT') {
                      navigation.navigate('BehaviorLRRecords', {
                        studentId,
                        tempId,
                      });
                    } else if (item === 'PI') {
                      navigation.navigate('BehaviorPIRecords', {
                        studentId,
                        tempId,
                      });
                    } else if (item === 'MT') {
                      navigation.navigate('BehaviorMTRecords', {
                        studentId,
                        tempId,
                      });
                    } else if (item === 'WI') {
                      navigation.navigate('BehaviorWIRecords', {
                        studentId,
                        tempId,
                      });
                    }
...
export default BehaviourDecelCard;
